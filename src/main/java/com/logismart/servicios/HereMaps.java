...
public class HereMaps implements ProveedorMapas {
    ...
    public double calcularDistancia(double lat1, double lon1, double lat2, double lon2) {
        // Haversine con factor de correccion por rutas brasilenas (1.4 por mayor tortuosidad)
        ...
        return distanciaLineal * 1.4;
    }

    @Override
    public String obtenerRuta(String origen, String destino) {
        String ruta = "[HERE Maps BR] Rota: " + origen + " → " + destino;
